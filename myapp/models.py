...
class User(models.Model):
    ...
    userpic = models.ImageField(db_column='UserPic', upload_to='user/', default='user/default.jpg')  # Field name made lowercase.
    usermodel = models.CharField(db_column='UserModel', max_length=150, null=True,blank=True)  # Field name made lowercase.
